...
(* Not needed anymore for CompCert v3.11 *)
...
Extract Constant mem_size => "Params.mem_size".
...
Separate Extraction
   ...
   common.jit_status
   backend.backend
   ASMinterpreter.init_nat_state
   ASMinterpreter.build_genv
   jit.jit_prog
   jit.jit_final_value
   jit.current_program
   jit.initial_jit_state
   exec
   ...
   monad.nasm_prog
   asm_step
   jit.native_load_spec
   jit.native_return_spec
   jit.native_step_spec.
